...
#define VERSION 'j'
#define DEVICE_NAME "W221 MERCEDES V1.0" //$CLUSTERMODEL $SKETCH_VERSION
#define MCB_EN // Board type, if not using Micro Control Boards by xConnect, do not define this.
#define LED_BUILTIN 2

#define UP_BTN_PIN 4 
#define OK_BTN_PIN 21
#define DOWN_BTN_PIN 16
#define LEFT_BTN_PIN 25
#define RIGHT_BTN_PIN 22


#ifndef MCB_EN
  #define MCP_EN_PIN 9 // Modify only when using arduino
#endif
#define DEVICE_UNIQUE_ID "f56ykemn-n1oh-p56c-yvwh-ahdx-7cuu8nezhwqi" // Generate ids randomly. Get a random ID from https://duid.xconnect.cc changeme-pret-typl-ease-hehe-iamatempid12
