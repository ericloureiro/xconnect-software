...
#define VERSION 'j'
#define DEVICE_NAME "PORSCHE CAYENNE V1.0" //$CLUSTERMODEL $SKETCH_VERSION
#define MCB_EN // Board type, if not using Micro Control Boards by xConnect, do not define this.
#define OK_BTN_PIN 34
#define BACK_BTN_PIN 32
#define UP_BTN_PIN 26
#define DWN_BTN_PIN 22
#define LED_BUILTIN 2
#ifndef MCB_EN
  #define MCP_EN_PIN 9 // Modify only when using arduino
#endif
#define DEVICE_UNIQUE_ID "tgof3tjq-u174-hggk-jm1a-rxbh-uyai94thdhdb" // Generate ids randomly. Get a random ID from https://duid.xconnect.cc changeme-pret-typl-ease-hehe-iamatempid12
